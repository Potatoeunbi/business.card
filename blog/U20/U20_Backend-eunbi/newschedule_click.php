...
<body>
    ...
    <div class="container" style="padding-bottom:0">
        ...
        <div class="something" style="padding: 0px 60px 60px 60px; height:800px;">
    ...
    <div class="container">
        ...
        <h3>조 구성원 변경</h3>
                ...
                <div class="btn_base base_mar col_right">
                    <input type="button"
                        onclick="window.open('change_member.php','창 이름','width=900,height=512,location=no,status=no,scrollbars=yes')"
                        class="btn_add bold  float_r" value="변경하기">
                </div>
